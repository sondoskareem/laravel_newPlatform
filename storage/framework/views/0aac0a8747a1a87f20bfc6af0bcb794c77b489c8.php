						...
						<div class="form-body">
							<div class="form-row">
								<div class="col-sm-10">
									...
									value="<?php echo e(old('name', $Courses->name)); ?>"
									autocomplete="off"
									 >
								</div>
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="form-row">
								<div class="col-sm-10">
									...
									autocomplete="off"
									>
									<?php echo e(old('description', $Courses->description)); ?>
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="form-row">
								<div class="col-sm-10">
									...
									class="form-control "
									id="validationCustom02" 
									value="<?php echo e(old('price', $Courses->price)); ?>"
									autocomplete="off"
									>
								</div>
							...
							<div class="form-row mt-4">
								<div class="col-sm-10">
									...
									<select name="category_id"  class="multiple-select" data-placeholder="Choose category" >
										...
										<option <?php if($Courses->category_id = $category->id): ?> selected <?php endif; ?> value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Laravel\Creative-Project-Company\Services\StageNew\resources\views/Courses/create.blade.php ENDPATH**/ ?>