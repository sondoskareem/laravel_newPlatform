...
<div class="page-wrapper">
	...
	<div class="row">
		...
		<div class="col-12 col-lg-9 mx-auto">
			<a href="{{route('CourseDetail.index' , $course_id)}}"><button
				type="button"
			...
			<div class="card radius-15">
				<div class="card-body">
					<div class="card-title">
						<h4 class="mb-0">{{__('dashboard.Upload Video')}}</h4>
					</div>
					<hr/>
								...
								<form>
									...
									<div class="input-group ">
										...
										<div class="custom-file">
											...
											<label id="labelVal" class="custom-file-label" for="inputGroupFile01" >{{__('dashboard.Choose file')}}</label>
										</div>
									</div> 
