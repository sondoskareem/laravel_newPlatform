		...
		<div class="page-wrapper" >
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					{{-- <a href="{{route('Coaches.create')}}"><button
					 type="button"
					  class="btn btn-primary m-1 mb-4 radius-30 px-5">
					  <i class='bx bx-user mr-1'></i>{{__('dashboard.Create Coaches')}}
					</button></a> --}}
					{{-- @endif --}}
					...
					<div class="card">
						<div class="card-body">
							<div class="card-title">
								<h4 class="mb-0">{{__('dashboard.Coaches Imported')}}</h4>
							</div>
							<hr/>
							@if($Coaches->count() > 0)
								...
								<table id="example2" class="table table-striped table-bordered" style="width:100%">
									...
									<tbody>
										...
										<tr>
											...
											<td> {{$Coache->name}}</td>
											<td> {{$Coache->email}}</td>
											<td> {{$Coache->created_at}}</td>
											<td>

												{{-- @if(auth()->user()->hasRole('admin')) --}}
												<a href="{{route('Courses.index',$Coache->id)}}">
												...
												data-toggle="modal" 
												data-target="#delete"
												data-url="{{route('Coaches.delete', [$Coache->id  ,'type' => request()->type])}}"
												>
												<i 
												class="bx bx-trash"
												style=
